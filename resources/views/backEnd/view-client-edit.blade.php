...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      <a href="{{route('clients.index')}}" class="btn btn-primary float-right btn-sm"><i class="fa fa-eye"></i> {{ A_VIEW_ALL }}</a>
    </div>
  </div><br>
    <!-- Outer Row -->
        ...
        <div class="card o-hidden border-0 shadow-lg">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  <h1 class="h4 text-gray-900 mb-4 page-home"><i class="fas fa-chevron-circle-right"></i> {{ A_EDIT_CLIENT }}</h1>
                  <form class="user" method="POST" action="{{ route('clients.update',$client->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <img src="{{ asset('upload/'.$client->photo) }}" class="show-img" id="showImage">
                      </div>
                    </div>
