        ...
        <div class="card o-hidden border-0 shadow-lg">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  <h1 class="h4 text-gray-900 mb-4 page-home"><i class="fas fa-chevron-circle-right"></i> {{ A_ADD_SERVICE }}</h1>
                  <form class="user" method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
                    @csrf
