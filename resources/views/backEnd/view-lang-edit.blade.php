        ...
        <div class="card o-hidden border-0 shadow-lg">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  <h1 class="h4 text-gray-900 mb-4 page-home"><i class="fas fa-chevron-circle-right"></i> {{ A_EDIT_LANGUAGE }}</h1>
                  <form class="user" method="POST" action="{{ route('languages.update',$language->id) }}">
                    @csrf
                    @method('PUT')
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select name="layout_direction" class="form-control">
                          <option value="Left" {{($language->layout_direction== 'Left') ? "selected":""}}>{{ A_LEFT }}</option>
                          <option value="Right" {{ $language->layout_direction == 'Right' ? "selected" : "" }}>{{ A_RIGHT }}</option>
                        </select>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <input type="checkbox" name="lang_default" value="1" class="lang-checkbox" {{ $language->lang_default == '1' ? "checked" : "" }}>
                      </div>
                    </div>
